...
const myBot = ['u734b3b03b3ce6459fab162958c0024a5','u4a361586c55ac4ef218a0a9b78b2f1b3','u4fd239a77c16d1ea7853cd801f6c379d','u3be861eaf85ef27656cf9159916229ca'];
...
\n";
        ...
        }else if(txt === 'คับ' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
